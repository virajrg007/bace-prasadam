$(document).ready(function() {
  ...
  // user.count.props((num,id)=>{
  //   if(num==0)
  //     $("[name="+id+"]").parent().removeClass("active");
  //   else
  //     $("[name="+id+"]").parent().addClass("active");
  // })
  // $(c1.parent).addClass("active");
  $(".cb-value").click(function() {
    var mainParent = $(this).parent(".toggle-btn");
    var mealNo = $(this).attr("name");
    if ($(mainParent).find("input.cb-value").is(":checked")) var mealStatus = 1;
    else var mealStatus = 0;
    $.ajax({
